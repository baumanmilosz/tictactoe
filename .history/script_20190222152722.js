...
console.log(firstRowBoxes.classList.includes);
...
if (firstRowBoxes[1].classList.contains('box circle') && firstRowBoxes[2].classList.contains('box circle') && firstRowBoxes[3].classList.contains('box circle')) {
  console.log('WIN');
}
