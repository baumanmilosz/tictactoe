...
function move() {
  ...
  if (firstRowBoxes[].classList.contains('circle') && secondRowBoxes[].classList.contains('circle') && thirdRowBoxes[].classList.contains('circle')) {
    winner.style.dis
  } play = "block";
}
winner.textContent = "CIRC}LE WIN";
